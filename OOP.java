...
class Car {
    ...
    // }
    public void details() {
        System.out.println("This is 5 gears engine, it is owned by " + owner + " and located in " + location + " it is "
                + color + " in color");
        startengine();
    }
    ...
    public void driveCar() {
        System.out.println("This is moving at gear " + gear + " and is moving " + trafficator
    ...
    public void packcar() {
        System.out.println(
                "This car is resetting your gear back to neutral...\n The car has packed\n The application has exited");
        System.exit(0);
    }
